...
void print_tmp_arr(){
    for(int i = 0; i < 5; i++){
        for(int j = 0; j < 5; j++) cout << tmp_arr[i][j] << " ";
        cout << "\n";
    }
    cout << "-------\n";
}
...
int get_benefit(){
    ...
    while (tmp_cost != 0){
        ...
        // cout << "cur_arr \n";
        // for(int i = 0; i < 5; i++){
        //     for(int j = 0; j < 5; j++) cout << cur_arr[i][j] << " ";
        //     cout << "\n";
        // }
        // cout << "\n";
        // cout << "tmp_arr \n";
...
int main(){
    ...
    while (K--){
        ...
        for(int a = 0; a < 3; a++){
            for(int b = 0; b < 3; b++){
                ...
                for(int deg = 90; deg <= 270; deg+=90){
                    rot_clockwise(a, b);
                    // cout << "cur tmp arr" << deg << "\n";
                    // print_tmp_arr();
                    int cost = do_first();
                    pq.push({a, b, deg, cost});
                    // cout << a << " " <<  b << " " << cost <<" " << deg << " degree finish\n";
                }
                rot_clockwise(a, b);
            }
        }
        auto value = pq.top();
        // cout << "values \n";
        // cout << value.x  << " " << value.y << " " << value.cost << value.degree << "\n";
